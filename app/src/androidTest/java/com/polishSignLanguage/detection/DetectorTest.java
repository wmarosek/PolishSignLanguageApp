...
import com.polishSignLanguage.detection.tflite.Detector.Recognition;
...
public class DetectorTest {
  ...
  private static final String MODEL_FILE = "app/src/main/ml/detect.tflite";
  private static final String LABELS_FILE = "app/src/main/assets/labelmap.txt";
  ...
  public void detectionResultsShouldNotChange() throws Exception {
    ...
    canvas.drawBitmap(loadImage("A83.png"), frameToCropTransform, null);
